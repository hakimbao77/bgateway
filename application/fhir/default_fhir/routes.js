var routesDefaultFHIR = function(app, DefaultFHIR){
	...
	app.get('/:apikey/act-priority/code/:code?', DefaultFHIR.get.actPriority);
	app.get('/:apikey/account-status/:_id?', DefaultFHIR.get.accountStatus);
	app.get('/:apikey/account-status/code/:code?', DefaultFHIR.get.accountStatus);
	app.get('/:apikey/account-type/:_id?', DefaultFHIR.get.accountType);
	app.get('/:apikey/account-type/code/:code?', DefaultFHIR.get.accountType);
	app.get('/:apikey/diagnosis-role/:_id?', DefaultFHIR.get.diagnosisRole);
	app.get('/:apikey/diagnosis-role/code/:code?', DefaultFHIR.get.diagnosisRole);
	app.get('/:apikey/encounter-admit-source/:_id?', DefaultFHIR.get.encounterAdmitSource);
	app.get('/:apikey/encounter-admit-source/code/:code?', DefaultFHIR.get.encounterAdmitSource);
	app.get('/:apikey/encounter-diet/:_id?', DefaultFHIR.get.encounterDiet);
	app.get('/:apikey/encounter-diet/code/:code?', DefaultFHIR.get.encounterDiet);
	app.get('/:apikey/encounter-discharge-disposition/:_id?', DefaultFHIR.get.encounterDischargeDisposition);
	app.get('/:apikey/encounter-discharge-disposition/code/:code?', DefaultFHIR.get.encounterDischargeDisposition);
	app.get('/:apikey/encounter-location-status/:_id?', DefaultFHIR.get.encounterLocationStatus);
	app.get('/:apikey/encounter-location-status/code/:code?', DefaultFHIR.get.encounterLocationStatus);
	app.get('/:apikey/encounter-participant-type/:_id?', DefaultFHIR.get.encounterParticipantType);
	app.get('/:apikey/encounter-participant-type/code/:code?', DefaultFHIR.get.encounterParticipantType);
	app.get('/:apikey/encounter-participant_type/:_id?', DefaultFHIR.get.encounterParticipantType);
	app.get('/:apikey/encounter-participant_type/code/:code?', DefaultFHIR.get.encounterParticipantType);
	app.get('/:apikey/encounter-reason/:_id?', DefaultFHIR.get.encounterReason);
	app.get('/:apikey/encounter-reason/code/:code?', DefaultFHIR.get.encounterReason);
	app.get('/:apikey/encounter-special-courtesy/:_id?', DefaultFHIR.get.encounterSpecialCourtesy);
	app.get('/:apikey/encounter-special-courtesy/code/:code?', DefaultFHIR.get.encounterSpecialCourtesy);
	app.get('/:apikey/encounter-special-arrangements/:_id?', DefaultFHIR.get.encounterSpecialArrangements);
	app.get('/:apikey/encounter-special-arrangements/code/:code?', DefaultFHIR.get.encounterSpecialArrangements);
	app.get('/:apikey/encounter-status/:_id?', DefaultFHIR.get.encounterStatus);
	app.get('/:apikey/encounter-status/code/:code?', DefaultFHIR.get.encounterStatus);
	app.get('/:apikey/encounter-type/:_id?', DefaultFHIR.get.encounterType);
	app.get('/:apikey/encounter-type/code/:code?', DefaultFHIR.get.encounterType);
	app.get('/:apikey/episode-of-care-type/:_id?', DefaultFHIR.get.episodeOfCareType);
	app.get('/:apikey/episode-of-care-type/code/:code?', DefaultFHIR.get.episodeOfCareType);
	app.get('/:apikey/episode-of-care-status/:_id?', DefaultFHIR.get.episodeOfCareStatus);
	app.get('/:apikey/episode-of-care-status/code/:code?', DefaultFHIR.get.episodeOfCareStatus);
	app.get('/:apikey/flag-status/:_id?', DefaultFHIR.get.flagStatus);
	app.get('/:apikey/flag-status/code/:code?', DefaultFHIR.get.flagStatus);
	app.get('/:apikey/flag-category/:_id?', DefaultFHIR.get.flagCategory);
	app.get('/:apikey/flag-category/code/:code?', DefaultFHIR.get.flagCategory);
	app.get('/:apikey/flag-code/:_id?', DefaultFHIR.get.flagCode);
	app.get('/:apikey/flag-code/code/:code?', DefaultFHIR.get.flagCode);
	...
	app.put('/:apikey/encounter-participant-type', DefaultFHIR.put.encounterParticipantType);	
	app.put('/:apikey/encounter-reason', DefaultFHIR.put.encounterReason);
