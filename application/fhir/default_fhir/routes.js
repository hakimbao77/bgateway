var routesDefaultFHIR = function(app, DefaultFHIR){
	...
	app.get('/:apikey/act_encounter_code/:_id?', DefaultFHIR.get.actEncounterCode);
	app.get('/:apikey/act_encounter_code/code/:code?', DefaultFHIR.get.actEncounterCodeCode);
	app.get('/:apikey/act_priority/:_id?', DefaultFHIR.get.actPriority);
	app.get('/:apikey/act_priority/code/:code?', DefaultFHIR.get.actPriority);
	app.get('/:apikey/account_status/:_id?', DefaultFHIR.get.accountStatus);
	app.get('/:apikey/account_status/code/:code?', DefaultFHIR.get.accountStatus);
	app.get('/:apikey/account_type/:_id?', DefaultFHIR.get.accountType);
	app.get('/:apikey/account_type/code/:code?', DefaultFHIR.get.accountType);
	app.get('/:apikey/diagnosis_role/:_id?', DefaultFHIR.get.diagnosisRole);
	app.get('/:apikey/diagnosis_role/code/:code?', DefaultFHIR.get.diagnosisRole);
	//app.get('/:apikey/encounter_admit_source/:_id?', DefaultFHIR.get.encounterAdmitSource);
	//app.get('/:apikey/encounter_admit_source/code/:code?', DefaultFHIR.get.encounterAdmitSource);
	//app.get('/:apikey/encounter_diet/:_id?', DefaultFHIR.get.encounterDiet);
	//app.get('/:apikey/encounter_diet/code/:code?', DefaultFHIR.get.encounterDiet);
	//app.get('/:apikey/encounter_discharge_disposition/:_id?', DefaultFHIR.get.encounterDischargeDisposition);
	//app.get('/:apikey/encounter_discharge_disposition/code/:code?', DefaultFHIR.get.encounterDischargeDisposition);
	//app.get('/:apikey/encounter_location_status/:_id?', DefaultFHIR.get.encounterLocationStatus);
	//app.get('/:apikey/encounter_location_status/code/:code?', DefaultFHIR.get.encounterLocationStatus);
	//app.get('/:apikey/encounter_participant_type/:_id?', DefaultFHIR.get.encounterParticipantType);
	//app.get('/:apikey/encounter_participant_type/code/:code?', DefaultFHIR.get.encounterParticipantType);
	//app.get('/:apikey/encounter_reason/:_id?', DefaultFHIR.get.encounterReason);
	//app.get('/:apikey/encounter_reason/code/:code?', DefaultFHIR.get.encounterReason);
	//app.get('/:apikey/encounter_special_courtesy/:_id?', DefaultFHIR.get.encounterSpecialCourtesy);
	//app.get('/:apikey/encounter_special_courtesy/code/:code?', DefaultFHIR.get.encounterSpecialCourtesy);
	//app.get('/:apikey/encounter_special_arrangements/:_id?', DefaultFHIR.get.encounterSpecialArrangements);
	//app.get('/:apikey/encounter_special_arrangements/code/:code?', DefaultFHIR.get.encounterSpecialArrangements);
	//app.get('/:apikey/encounter_status/:_id?', DefaultFHIR.get.encounterStatus);
	//app.get('/:apikey/encounter_status/code/:code?', DefaultFHIR.get.encounterStatus);
	//app.get('/:apikey/encounter_type/:_id?', DefaultFHIR.get.encounterType);
	//app.get('/:apikey/encounter_type/code/:code?', DefaultFHIR.get.encounterType);
	//app.get('/:apikey/episode_of_care_type/:_id?', DefaultFHIR.get.episodeOfCareType);
	//app.get('/:apikey/episode_of_care_type/code/:code?', DefaultFHIR.get.episodeOfCareType);
	//app.get('/:apikey/episode_of_care_status/:_id?', DefaultFHIR.get.episodeOfCareStatus);
	//app.get('/:apikey/episode_of_care_status/code/:code?', DefaultFHIR.get.episodeOfCareStatus);
	//app.get('/:apikey/flag_status/:_id?', DefaultFHIR.get.flagStatus);
	//app.get('/:apikey/flag_status/code/:code?', DefaultFHIR.get.flagStatus);
	//app.get('/:apikey/flag_category/:_id?', DefaultFHIR.get.flagCategory);
	//app.get('/:apikey/flag_category/code/:code?', DefaultFHIR.get.flagCategory);
	//app.get('/:apikey/flag_code/:_id?', DefaultFHIR.get.flagCode);
	//app.get('/:apikey/flag_code/code/:code?', DefaultFHIR.get.flagCode);
	//app.get('/:apikey/re_admission_indicator_/:_id?', DefaultFHIR.get.reAdmissionIndicator);
	//app.get('/:apikey/re_admission_indicator_/code/:code?', DefaultFHIR.get.reAdmissionIndicator);
